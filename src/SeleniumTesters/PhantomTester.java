...
public class PhantomTester {
    public static void main(String[] args) {
        PhantomTester example = new PhantomTester();
    ...
    public void runPhantomjsWebDriver()
    {
        try
        {
            ...
            String phantomjsExeutableFilePath = "C:/Users/donne/Dropbox/BIT/Roach/Roach/Roach/drivers/phantomjs.exe";
